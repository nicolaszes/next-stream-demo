...
import { DefaultErrorCapturePlugin, DefaultLazyLoadPlugin } from '../../../components/StandardContainer/plugins';
        ...
        <div className="px-4 py-6">
          ...
          <div className="space-y-4">
            {articles.map((article) => (
              <div key={(article as {id: number}).id} className="flex space-x-3 p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
                ...
                <div className="flex-shrink-0">
                  {(article as {image: string | null}).image ? (
                    utils.createLazyImage((article as {image: string | null}).image, (article as {title: string}).title, {
